"""
Seed the database with Atlas demo data (R101–R108) and technicians.
Run: python seed.py
"""
import sqlite3
import os
...
# missing_info pipe-separated, needs_clarification 0/1
REQUESTS = [
    # id, customer, channel, message, received_at, priority, status, technician_id, is_dup, dup_of, needs_clarif, missing_info, notes
    (
        "R101", "C01", "email",
        "Cold-room unit keeps stopping. Stored goods could be affected.",
        "2026-09-30T16:10:00",
        "urgent", "open", None, 0, None, 0, None,
    ...
    (
        ...
        "2026-10-01T08:20:00",
        "high", "assigned", "T1", 0, None, 0, None,
    ...
    (
        ...
        "2026-09-30T11:00:00",
        "normal", "open", None, 0, None, 0, None,
        None,
    ),
    (
        "R104", "C01", "email",
    ...
    (
        ...
        "2026-10-01T08:30:00",
        "normal", "open", None, 0, None, 1,
        "Equipment identifier missing",
        None,
    ),
    (
        "R106", "C05", "email",
        ...
        "2026-09-29T14:00:00",
        "normal", "waiting", "T2", 0, None, 0, None,
    ...
    (
        ...
        "2026-09-30T15:00:00",
        "normal", "in_progress", "T3", 0, None, 0, None,
...
def seed():
    ...
    for t in TECHNICIANS:
        conn.execute("INSERT OR REPLACE INTO technicians (id, name, status) VALUES (?, ?, ?)", t)
    ...
    conn.commit()
    conn.close()
    print(f"Seeded {len(TECHNICIANS)} technicians and {len(REQUESTS)} requests into {DB_PATH}")
